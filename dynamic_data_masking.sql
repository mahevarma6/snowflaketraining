...
insert into  employee_info values(1,'2020-10-01','HR',40000,4),
...
ALTER TABLE IF EXISTS employee_info MODIFY COLUMN dept SET MASKING POLICY sensitive_info_masking_string; 
...
ALTER TABLE IF EXISTS employee_info MODIFY COLUMN dept SET MASKING POLICY sensitive_info_masking_numbers;
